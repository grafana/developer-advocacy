...
1. Update the following HTML code with the new dashboard details. Refer to the inline comments for more information.
      ...
      ```
1. Save the changes and update the [dashboard's JSON model](https://github.com/grafana/grafana-play/blob/main/play-frontend/dashboards/examples/homepage-refresh-2025.json) in the Grafana Play repo.

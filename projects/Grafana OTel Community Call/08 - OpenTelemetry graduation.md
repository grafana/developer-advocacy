...
# [[08 - OpenTelemetry graduation]]

[Link to YouTube video]()

Hosts: "Nicole van der Hoeven", "Tiffany Jernigan", "Imma Valls"
Guests: "Ted Young", "Marylia Gutierrez", "Tiffany Hrabusa"
...
- [x] Contact the guests and tell them about Grafana OTel Community Call.
...
- [ ] Invite them to the Grafana OTel Community Call calendar invite (choose "this instance only", not the whole series). Schedule the invite for 15 minutes before the stream (to do a tech check) until 15 minutes after the stream (to debrief). The invite should be for 1.5 hours total. Explain this to them.
- [ ] Create a thumbnail on [Canva](https://canva.com) using the Grafana OTel Community Call thumbnail format. Use [thumbsup.tv](https://thumbsup.tv) to check how the thumbnail looks on different devices. [Here are some guidelines for creating thumbnails](https://notes.nicolevanderhoeven.com/Create+engaging+thumbnails).
- [ ] Schedule the broadcast on [Streamyard](https://streamyard.com), and select the Grafana YouTube channel as the destination.
	- [ ] In the title, include the instance of Grafana OTel Community Call, i.e. `OpenTelemetry graduation (Grafana OTel Community Call #08)`. Including the number or the date (such as `All About Explore Logs (Loki Community Call November 2024`) helps people remember it.
	- [ ] Add the standard description as per previous Grafana OTel Community Call shows. Check the video description and add guests' contact details.
...
- [ ] Get the Streamyard invite link and put it in the "location" of the calendar invite to the guests.
...
- Intro
	- *Hello and welcome to Grafana OTel Community Call. I'm `<name>`, a `<position>` at Grafana Labs and today, we're going to talk about OpenTelemetry's graduation from the CNCF.*
- Announcements
- Introduce guests
	- Ted Young
	- Marylia Gutierrez
	- Tiffany Hrabusa
- [ ] What does CNCF graduation actually mean?
	- The CNCF maturity levels (Sandbox / Incubating / Graduated) and what each signals to adopters
	- Criteria OpenTelemetry had to meet: adoption, governance, security audits, diversity of contributors
	- How long did this take, and what was the journey like?
- [ ] Why this matters to users
	- What changes for end users now that OTel is graduated?
	- Signals of long-term stability for enterprises betting on OTel
	- How does graduation compare to component stability (signals, SDKs, semconv)?
- [ ] The road here
	- Key milestones in the project's history
	- What were the hardest parts of getting to graduation?
	- Surprising moments along the way
- [ ] The state of the signals
	- Traces, metrics, logs — where is each today?
	- Profiling and other emerging signals
	- Semantic conventions progress
- [ ] What's next after graduation?
	- Priorities for the next year
	- Areas that still need contributors
	- How can the community help?
- [ ] The human side
	- Each guest's OTel story: how did you get involved?
	- Favorite moment in the project
	- Advice for someone wanting to contribute today
